    ...
    <div class="section_2 flex-col">
      ...
      <div class="box_3 flex-row">
        <div class="text-wrapper_8 flex-col justify-between">
          <span class="text_10">地址</span>
          <span class="text_11">云南省昆明市五华区学府路海伦先生&nbsp;1&nbsp;栋&nbsp;11&nbsp;楼</span>
        </div>
        <div class="text-group_1 flex-col justify-between">
          <span class="text_12">联系方式</span>
        ...
        <div class="text-group_2 flex-col justify-between">
          <span class="text_13">邮编</span>
          <span class="text_14">655000</span>
        </div>
      </div>
