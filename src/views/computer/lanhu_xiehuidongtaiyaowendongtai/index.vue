    ...
    <div class="group_6 flex-col">
      <div class="box_1 flex-col justify-end">
        ...
        <div class="text-wrapper_7 flex-row">
          <router-link class="text_9" to="/computer/xiehuidongtaitongzhigonggao">通知公告</router-link>
...
export default {
  ...
  data() {
    return {
      tongzhigonggaoList: [
        {
          imgSrc: require('@/views/computer/lanhu_xiehuidongtaiyaowendongtai/assets/img/MasterDDSSlicePNGe7cfbbbf3db36de264772a5d846c3b92.png'),
          time:'2025-02-17',
          title: '云南省发明协会积极组织科技活动周活动',
        },
        {
          imgSrc:require('@/views/computer/lanhu_xiehuidongtaiyaowendongtai/assets/img/MasterDDSSlicePNGb6749eaad4c0f2e30051a8dece9f67fe.png'),
          time:'2025-03-16',
          title: '云南省发明协会入围作品答辩培训及终评颁奖通知',
        },
        {
          imgSrc:require('@/views/computer/lanhu_xiehuidongtaiyaowendongtai/assets/img/MasterDDSSlicePNG78716aa99165448ee0d8d3d6027ef329.png'),
          time:'2025-03-04',
          title: '云南省发明协会积极组织科技活动周活动',
        },
        {
          imgSrc: require('@/views/computer/lanhu_xiehuidongtaiyaowendongtai/assets/img/textimage.png'),
          time:'2025-02-17',
