    ...
    <div class="block_2 flex-col">
      <div class="box_1 flex-col justify-end">
        ...
        <div class="text-wrapper_7 flex-row">
          ...
          <router-link class="text_11" to="xiehuigaikuangxiehuilingdao">协会领导</router-link>
          <span class="text_12">协会业绩</span>
        </div>
      </div>
      <div class="box_2 flex-row justify-between">
        <div class="box_3 flex-col">
          <div class="text-wrapper_8">
            <span class="text_13">（一）开展非职务发明创造转化运用学术研究工作</span>
        ...
        <div class="box_4 flex-col">
          <div class="text-wrapper_9">
            <span class="text_14">（三）组织参加中国专利奖评选</span>
        ...
        <div class="section_2 flex-col">
          <div class="block_3 flex-row">
            <div class="text-group_1 flex-col justify-between">
              <span class="text_16">云南省发明协会</span>
              <span class="text_17">地址：云南省昆明市五华区学府路海伦先生&nbsp;1&nbsp;栋&nbsp;11&nbsp;楼</span>
            </div>
          </div>
          <div class="block_4 flex-row justify-between">
            <div class="text-group_2 flex-col justify-between">
              <span class="text_18">联系方式</span>
            ...
            <router-link class="text-wrapper_10 flex-col" to="lianxiwomen"><span class="text_19" target="_blank">联系我们&nbsp;→</span></router-link>
          </div>
        </div>
      </div>
    </div>
