    ...
    <div class="section_6 flex-col">
      ...
      <div class="group_3 flex-row">
        <img
          class="image_2"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNGa726d9df2d888001b7fd83bd96dd72ef.png"
        />
        <div class="block_4 flex-col justify-between">
          <span class="text_12">搞定科技有限公司</span>
          <div class="text-wrapper_8">
            <span class="paragraph_2">
              搞定科技（Yuanshi&nbsp;Technology）作为聚焦人工智能与量子计算的前沿科技企业，近年来在核心技术研发与创新应用领域实现多项突破：
              <br />
              󰀐技术突破
              <br />
              󰀡人工智能：自主研发“DeepSeek-R1”多模态大模型，推理效率较行业基准提升40%，获2024年世界人工智能大会创新奖。
              <br />
              󰀡量子计算：完成首款可编程量子芯片“Q-Core&nbsp;5”研发，支持128量子比特运算，联合中科院实现量子化学模拟商业化落地。
              <br />
              󰀡新能源技术：推出固态电池“EnerX”，能量密度达500Wh/kg，已与蔚来、宁德时代签订合作协议。
              <br />
              󰀐专利布局
              <br />
              <br />
              累计申请发明专利200余项，覆盖AI算法优化、量子纠错编码等核心技术，其中80项获中国、美国、欧盟授权，核心专利入选2023年“中国专利银奖”。
              <br />
              󰀐社会价值
              <br />
              󰀡产业赋能：AI工业质检平台服务超500家制造企业，平均良品率提升15%；
              <br />
              󰀡绿色创新：参与青海“零碳智慧园区”建设，光伏-氢能协同系统减排效率达行业领先水平。
              <br />
              目前，搞定科技已与斯坦福大学、华为云等共建联合实验室，并入选《麻省理工科技评论》“全球50家聪明公司”榜单，持续推动科技向善与产业革新。
            </span>
      ...
      <div class="group_4 flex-row justify-between">
        <img
          class="image_3"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNG31f5abb001cb61cf1804a7e66dd993d5.png"
        />
        <div class="image-wrapper_1 flex-col">
          <img
            class="image_4"
            referrerpolicy="no-referrer"
            src="./assets/img/MasterDDSSlicePNG54143c1411f2f9e798846dfce5157d13.png"
          />
        </div>
        <img
          class="image_5"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNG13f1aeb194cf075df451d79147532324.png"
        />
        <img
          class="image_6"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNGd76268a9ebc608ceb1f1fe64bff63be5.png"
        />
      </div>
      <div class="image-wrapper_2 flex-row justify-between">
        <img
          class="image_7"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNG58a2f79100d60bef1772d88f63c5f12a.png"
        />
        <img
          class="image_8"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNG8af211c8249b6ffa499b77d26389a1c8.png"
        />
        <img
          class="image_9"
          referrerpolicy="no-referrer"
          src="./assets/img/MasterDDSSlicePNG8d62a612d1d1ad6c4c56e68015656534.png"
        />
        <img
          class="image_10"
          referrerpolicy="no-referrer"
