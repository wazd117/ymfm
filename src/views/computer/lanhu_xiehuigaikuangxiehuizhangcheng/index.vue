    ...
    <div class="block_2 flex-col">
      <div class="box_5 flex-col justify-end">
        ...
        <div class="text-wrapper_7 flex-row">
          <router-link class="text_9" :to="'/computer/xiehuigaikuangxiehuijianjie'">协会简介</router-link>
          <span class="text_10">协会章程</span>
      ...
      <div class="box_6 justify-between">
        <div class="section_5 ">
          <div class="text-wrapper_8">
            <span class="text_13">第一章总则</span>
